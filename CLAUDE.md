...
[완료] 장애 테스트 T01~T06 통과
[예정] 장애 테스트 T07 (ASG 인스턴스 종료)
...
**장애 테스트 (T01~T06)**: "7개 시나리오 중 T01~T06 실제 AWS 환경에서 검증 완료. T03은 campaign 24(유실 141,062) vs campaign 27(유실 0) DB 쿼리로 대체 증명. T05에서 VUS=500으로도 Kafka lag 스파이크 → 즉시 해소 확인. 5xx 0건"
